...
if("TRUE" STREQUAL "TRUE")
  set(costmap_2d_SOURCE_PREFIX /home/breno/wheeltec_ws/src/navigation-melodic/costmap_2d)
  set(costmap_2d_DEVEL_PREFIX /home/breno/wheeltec_ws/devel)
  ...
  set(costmap_2d_INSTALL_PREFIX /home/breno/wheeltec_ws/install)
...
if(NOT "/home/breno/wheeltec_ws/devel/include;/home/breno/wheeltec_ws/src/navigation-melodic/costmap_2d/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  set(costmap_2d_INCLUDE_DIRS "")
  set(_include_dirs "/home/breno/wheeltec_ws/devel/include;/home/breno/wheeltec_ws/src/navigation-melodic/costmap_2d/include;/usr/include/eigen3;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'costmap_2d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/breno/wheeltec_ws/src/navigation-melodic/costmap_2d/${idir}'.  ${_report}")
    endif()
    _list_append_unique(costmap_2d_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "costmap_2d;layers;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_thread-mt.so;-lpthread;/usr/lib/x86_64-linux-gnu/libboost_chrono.so;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_atomic.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/breno/wheeltec_ws/devel/lib;/home/breno/catkin_ws/devel/lib;/opt/ros/melodic/lib)
